...
namespace elastic
{
	...
	{
	protected:
		basic_oarchive([[maybe_unused]] uint32_t flags = 0)
	...
	public:
		void register_basic_serializer([[maybe_unused]] const basic_oserializer& bos)
		{
			//impl_ptr_->register_type(bos);
		}

		void save_object([[maybe_unused]] const void* x, [[maybe_unused]] const basic_oserializer& bos)
		{
			//return impl_ptr_->save_object(x, bos);
		}

		void save_pointer([[maybe_unused]] const void* t, [[maybe_unused]] const basic_pointer_oserializer* bpos_ptr)
		{
